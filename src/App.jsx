    ...
    async function connectToWeb3() {
      if (window.ethereum) {
        try {
          ...
          const withdrawableDividendInWei = await contract.methods
            .withdrawableDividendOf(accounts[0])
            .call();
          const withdrawableDividendInEther = web3.utils.fromWei(
            withdrawableDividendInWei,
            "ether"
          );
            ...
            <div className="contentwrap">
              <div className="content">
                <div className="flex-items">
                  <div className="title">Account</div> <div className="mobile-only">{account}</div>
                </div>

                <div className="flex-items">
                  <div className="title">Token Balance</div> {balance} CIA
                </div>

                <div className="flex-items">
                  <div className="title">Rewards Balance</div>{" "}
                  {withdrawableDividends} BNB
                </div>
              </div>
            </div>
